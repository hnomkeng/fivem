...
Config.PoliceStations = {
  ...
  LSPD1 = {
    ...
    AuthorizedVehicles = {
      ...
      { name = 'policebvn', label = 'Moto' },
      { name = 'policet', label = 'Van de transport' },
	  { name = 'polmp4', label = 'McLaren police' },
	  { name = 'polgs350', label = 'Lexus police' },
	  { name = 'policeinsurgent', label = 'ins police' },
	  { name = 'Valkyrie', label = 'Valkyrie police' },
	  },
    ...
    Vehicles = {
      {
        ...
        SpawnPoint = { x = 416.8050, y = -1019.689, z = 29.1468 },
        Heading    = 90.0
      }
    },
    ...
    Vehicles = {
      {
        ...
        SpawnPoint = {x = -469.77, y = 6023.75, z = 31.34 },
        Heading    = 87.0
      }
    },
  ...
  SASP2 = {
    ...
    AuthorizedVehicles = {
      { name = 'polgs350', label = 'Lexus police' },
	  { name = 'porschepd', label = 'Porsche police' },
      { name = 'audipd', label = 'Audi Police' },
      { name = 'mclarenpd', label = 'McLaren police' },
	  { name = 'polchiron', label = 'Bugatti police' },
	  { name = 'polmarsh', label = '4x4 police' },
      { name = 'police4', label = 'Véhicule civil' },
      { name = 'policebvn', label = 'Moto' },
      { name = 'policet', label = 'Van de transport' },
	  { name = 'policeinsurgent', label = 'ins police' },
    ...
    Vehicles = {
      {
        ...
        SpawnPoint = {x = 1863.059, y = 3648.39, z = 33.68 },  -- state pd
        Heading    = 90.0 --state pd
      }
    },
